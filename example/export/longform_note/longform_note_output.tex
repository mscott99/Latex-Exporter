...
We cite as follows: \cite{vershyninHighDimensionalProbabilityIntroduction2018}. A \emph{textcite} can also be used: the book is by \textcite{vershyninHighDimensionalProbabilityIntroduction2018}. Specific results can be referenced: \cite[Example 5.4]{vershyninHighDimensionalProbabilityIntroduction2018}. Multi-citations are also supported: \cite{berkCoherenceParameterCharacterizing2022, berkModeladaptedFourierSampling2023}.

I cite an earlier work of mine through a standard wikilink, by using the ``source" field in the yaml header: \cite{earlier_longform_bibkey}.

Alternatively, pandoc syntax also works, though you may want to set the default citation command to \emph{textcite} in the plugin settings. \textcite{vershyninHighDimensionalProbabilityIntroduction2018}, \citeyear{vershyninHighDimensionalProbabilityIntroduction2018}, \textcite[Example 2.1]{vershyninHighDimensionalProbabilityIntroduction2018}, \cite{berkCoherenceParameterCharacterizing2022, berkModeladaptedFourierSampling2023}, 
\parencite{berkCoherenceParameterCharacterizing2022, berkModeladaptedFourierSampling2023} and then \parencite{vershyninHighDimensionalProbabilityIntroduction2018}.
...
Indeed, $1+1  =  2$.
\end{theorem}
We can link to \hyperref[loc:theorem_1.proof]{the proof} with a wikilink to the ``Proof" header.
...
\end{lemma}
We defer \hyperref[loc:lemma_1.proof]{the proof} to the appendix.
\begin{lemma}
...
cite the previous work with a simple wikilink: \cite{earlier_longform_bibkey},
and similarly for the result: \cite[Proposition 3.1]{scottpaper}. To do this, you must set the yaml header ``source" to the bibkey of the previous work, and additionally the header ``published\_result\_name" to, e.g., ``Proposition 3.1", for the cited result. 
...
\caption{Caption is here. You can always do things. This is also part of the caption. Features work inside the caption: \Cref{loc:lemma_2.statement}.
\label{fig:intro_comp_wlabel.pdf}}
\end{figure}
